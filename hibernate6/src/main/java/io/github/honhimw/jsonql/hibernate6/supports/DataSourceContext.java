...
import io.github.honhimw.jsonql.hibernate6.MutablePersistenceUnitInfo;
import io.github.honhimw.jsonql.hibernate6.ddl.MetadataExtractor;
...
public class DataSourceContext implements AutoCloseable {
    ...
    private DataSourceContext(Builder builder) {
        ...
        hibernateProperties.put("hibernate.implicit_naming_strategy", "org.hibernate.boot.model.naming.ImplicitNamingStrategyJpaCompliantImpl");
